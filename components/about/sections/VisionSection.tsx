...
export const VisionSection: React.FC = () => {
  ...
  return (
    <section ref={ref} className="relative w-full pt-16 md:pt-20 pb-12 md:pb-16 bg-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 flex flex-col md:flex-row items-center gap-12 md:gap-16">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-6 text-left">
          ...
          {/* Icon rows with titles and descriptions */}
          <motion.div
          ...
          >
            ...
            <div className="flex gap-4 items-start">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-brand-primary/10 text-brand-primary transition-colors duration-300 shrink-0 mt-1">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M6 8L11 12L18.5 1.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
            ...
            <div className="flex gap-4 items-start">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-brand-primary/10 text-brand-primary transition-colors duration-300 shrink-0 mt-1">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M4.5 4.5L6.5 6.5M14 5L13 6M16 15.75L13 12M6 14.5L8 12.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
              <div className="flex flex-col">
