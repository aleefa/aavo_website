...
export const MissionSection: React.FC = () => {
  ...
  const missionItems = [
    {
      ...
      icon: (
        <svg viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[19.2px] h-6">
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 14 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[16.8px] h-6">
  ...
  return (
    <section ref={ref} className="relative w-full pt-16 md:pt-12 pb-16 md:pb-20 bg-white overflow-hidden">
