...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-280 mx-auto px-5 pt-17.75 md:pb-28 flex flex-col lg:flex-row lg:gap-13 gap-8 items-start">
        ...
        <main className="flex-1 flex flex-col min-w-0 lg:gap-12 md:gap-8  gap-[72px]">
          ...
          >
            ...
            />
            <div className="flex flex-col gap-5 md:pl-[72px]">
              {[
                {
                  icon: (
                    <svg
